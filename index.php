...
$result = get_CURL('https://www.googleapis.com/youtube/v3/channels?part=snippet,statistics&id=UCkXmLjEr95LVtGuIm3l2dPg&key=AIzaSyCvoN8ppMgVnD5MHYp8KbJ-UGbUyQk7fzk');
...
// latestivideo
$urllatestvideo = 'https://www.googleapis.com/youtube/v3/search?key=AIzaSyCvoN8ppMgVnD5MHYp8KbJ-UGbUyQk7fzk&channelId=UCkXmLjEr95LVtGuIm3l2dPg&maxResult=1&order=date&part=snippet';
...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#home">Sani Swandika</a>
        ...
        <div class="row pt-4 mb-4">
          ...
          <div class="row justify-content-center">
            <div class="col-md-5">
              <div class="row">
                <div class="col-md-4">
                  <img src="<?= $youtubeprofilepic; ?>" width="1000" class="rounded-circle img-thumbnail">
                </div>
                 <div class="col-md-8">
                    <h5><?= $channelname; ?></h5>
                    <p><?= $subscriber; ?><p> 
              ...
              <div class="row mt-3 pb-3">
                <div class="col">
                  <div class="ig-thumbnail">
                    <img src="img/thumbs/1.png" alt=""width="100">
                  </div>
                  <div class="ig-thumbnail">
